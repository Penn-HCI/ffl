...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c11 = function(global: any, ds: any): any {
  ...
  const peg$c20 = function(ss: any, sse: any): any {
          return [...ss.map((s : any) => s[0]), sse];
      };
  const peg$c21 = function(sse: any, ss: any): any {
          return [sse, ...ss.map((s : any) => s[1])];
      };
  const peg$c22 = function(s: any): any { return [s] };
  const peg$c23 = function(s: any, ps: any): any {
  ...
  const peg$c28 = function(id: any, arg: any): any {
      return { class: id, arg }
  };
  const peg$c29 = "nth";
  ...
  const peg$c33 = function(expr: any): any { return { type : "literal", str: expr }; };
  const peg$c34 = ".";
  const peg$c35 = peg$literalExpectation(".", false);
  const peg$c36 = function(ident: any): any { return  { type : "class", str: ident }; };
  const peg$c37 = ";";
  const peg$c38 = peg$literalExpectation(";", false);
  const peg$c39 = function(ha: any, ta: any): any {
  ...
  const peg$c42 = function(v: any): any { return { label: v }; };
  const peg$c43 = "html(";
  const peg$c44 = peg$literalExpectation("html(", false);
  const peg$c45 = function(v: any): any { 
  ...
  const peg$c46 = function(v: any): any { return { renderType: "plain", value: v }; };
  const peg$c47 = "\"";
  const peg$c48 = peg$literalExpectation("\"", false);
  const peg$c49 = "\\\"";
  const peg$c50 = peg$literalExpectation("\\\"", false);
  const peg$c51 = peg$anyExpectation();
  const peg$c52 = function(s: any): any { return s.replaceAll('\\"', '"') };
  const peg$c53 = "'";
  const peg$c54 = peg$literalExpectation("'", false);
  const peg$c55 = "\\'";
  const peg$c56 = peg$literalExpectation("\\'", false);
  const peg$c57 = function(s: any): any { return s.replaceAll('\\\'', '\'') };
  const peg$c58 = function(k: any, v: any): any { return { [k.trim()]: v.trim() }; };
  const peg$c59 = "--";
  ...
  const peg$c77 = function(): any { return null; };
  const peg$c78 = " ";
  ...
  function peg$parsedescendantGroup_(): any {
  ...
  function peg$parsepseudoFunc(): any {
    let s0;
  ...
  function peg$parseproperties(): any {
