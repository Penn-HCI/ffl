...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c12 = function(s: any): any { return [s] };
  ...
  const peg$c21 = function(ss: any, sse: any): any {
          return [...ss.map((s : any) => s[0]), sse];
      };
  const peg$c22 = function(s: any, ps: any): any {
  ...
  const peg$c27 = function(id: any, arg: any): any {
      return { class: id, arg }
  };
  const peg$c28 = "nth";
  ...
  const peg$c32 = function(expr: any): any { return { type : "literal", str: expr }; };
  const peg$c33 = ".";
  const peg$c34 = peg$literalExpectation(".", false);
  const peg$c35 = function(ident: any): any { return  { type : "class", str: ident }; };
  const peg$c36 = ";";
  const peg$c37 = peg$literalExpectation(";", false);
  const peg$c38 = function(ha: any, ta: any): any {
  ...
  const peg$c41 = function(v: any): any { return { label: v }; };
  const peg$c42 = "html(";
  const peg$c43 = peg$literalExpectation("html(", false);
  const peg$c44 = function(v: any): any { 
  ...
  const peg$c45 = function(v: any): any { return { renderType: "plain", value: v }; };
  const peg$c46 = "\"";
  const peg$c47 = peg$literalExpectation("\"", false);
  const peg$c48 = "\\\"";
  const peg$c49 = peg$literalExpectation("\\\"", false);
  const peg$c50 = peg$anyExpectation();
  const peg$c51 = function(s: any): any { return s.replaceAll('\\"', '"') };
  const peg$c52 = "'";
  const peg$c53 = peg$literalExpectation("'", false);
  const peg$c54 = "\\'";
  const peg$c55 = peg$literalExpectation("\\'", false);
  const peg$c56 = function(s: any): any { return s.replaceAll('\\\'', '\'') };
  const peg$c57 = function(k: any, v: any): any { return { [k.trim()]: v.trim() }; };
  const peg$c58 = "--";
  ...
  const peg$c76 = function(): any { return null; };
  const peg$c77 = " ";
