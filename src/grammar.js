...
function peg$parse(input, options) {
    ...
    const peg$c19 = "label";
    const peg$c20 = peg$literalExpectation("label", false);
    const peg$c21 = ":";
    const peg$c22 = peg$literalExpectation(":", false);
    const peg$c23 = function (v) { return { label: v }; };
    const peg$c24 = "html(";
    const peg$c25 = peg$literalExpectation("html(", false);
    const peg$c26 = ")";
    const peg$c27 = peg$literalExpectation(")", false);
    const peg$c28 = function (v) { return { renderType: "html", value: (0, sanitize_html_1.default)(v) }; };
    const peg$c29 = function (v) { return { renderType: "plain", value: v }; };
    const peg$c30 = "\"";
    const peg$c31 = peg$literalExpectation("\"", false);
    const peg$c32 = "\\\"";
    const peg$c33 = peg$literalExpectation("\\\"", false);
    const peg$c34 = peg$anyExpectation();
    const peg$c35 = function (s) { return s.replaceAll('\\"', '"'); };
    const peg$c36 = "'";
    const peg$c37 = peg$literalExpectation("'", false);
    const peg$c38 = "\\'";
    const peg$c39 = peg$literalExpectation("\\'", false);
    const peg$c40 = function (s) { return s.replaceAll('\\\'', '\''); };
    const peg$c41 = function (k, v) { return { [k.trim()]: v.trim() }; };
    const peg$c42 = "--";
    ...
    const peg$c48 = "_";
    const peg$c49 = peg$literalExpectation("_", false);
    const peg$c50 = /^[A-Z]/;
    const peg$c51 = peg$classExpectation([["A", "Z"]], false, false);
    const peg$c52 = /^[a-z]/;
    const peg$c53 = peg$classExpectation([["a", "z"]], false, false);
    const peg$c54 = /^[\-.]/;
    ...
    const peg$c67 = "\v";
    const peg$c68 = peg$literalExpectation("\v", false);
    const peg$c69 = "\f";
    const peg$c70 = peg$literalExpectation("\f", false);
    let peg$currPos = 0;
    let peg$savedPos = 0;
