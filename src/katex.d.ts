...
declare module "katex" {
    ...
    export default class katex {
         ...
         */
        static __parse(expression: string, options: KatexOptions): any[];
        /**
         ...
         * to change. Use at your own risk.
         */
        static __renderToDomTree(expression: string, options: KatexOptions): any;
        /**
         ...
         * to change. Use at your own risk.
         */
        static __renderToHTMLTree(expression: string, options: KatexOptions): any;
        /**
