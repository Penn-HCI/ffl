...
<span hidden>excerpt adapted from <i>Hohman et al., Gamut, CHI '19<i/><span/>`);
...
$x_1$ {
  ...
  try {
    ...
    const gErr = err as GrammarError;
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'row', height: '100vh', width: '100vw' }}>
      <Container maxWidth='xl' sx={{ height: '100%', padding: '8pt', flex: 1 }} className='App'>
        <Stack
          spacing={2} direction='row' flex={1}
          alignItems='stretch' justifyContent='space-around'
          sx={{ height: '100%', width: 'auto', flex: 1 }} flexDirection={'row'}>
