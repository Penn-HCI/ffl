...
function peg$parse(input, options) {
    ...
    const peg$c12 = "intersect";
    const peg$c13 = peg$literalExpectation("intersect", false);
    const peg$c14 = "ion";
    const peg$c15 = peg$literalExpectation("ion", false);
    const peg$c16 = "(";
    const peg$c17 = peg$literalExpectation("(", false);
    const peg$c18 = ")";
    const peg$c19 = peg$literalExpectation(")", false);
    const peg$c20 = function (ss, sse) {
        return [...ss.map((s) => s[0]), sse];
    };
    const peg$c21 = function (sse, ss) {
        return [sse, ...ss.map((s) => s[1])];
    };
    const peg$c22 = function (s) { return [s]; };
    const peg$c23 = function (s, ps) {
    ...
    const peg$c28 = function (id, arg) {
        return { class: id, arg };
    };
    const peg$c29 = "nth";
    const peg$c30 = peg$literalExpectation("nth", false);
    const peg$c31 = "$";
    const peg$c32 = peg$literalExpectation("$", false);
    const peg$c33 = function (expr) { return { type: "literal", str: expr }; };
    const peg$c34 = ".";
    const peg$c35 = peg$literalExpectation(".", false);
    const peg$c36 = function (ident) { return { type: "class", str: ident }; };
    const peg$c37 = ";";
    const peg$c38 = peg$literalExpectation(";", false);
    const peg$c39 = function (ha, ta) {
        return [ha, ...ta].reduce((acc, ent) => {
            return merge(acc, ent, (a, b) => { throw 'value should always be strings'; }, (arr1, arr2) => {
                arr1 ??= [];
    ...
    const peg$c40 = "label";
    const peg$c41 = peg$literalExpectation("label", false);
    const peg$c42 = function (v) { return { label: v }; };
    const peg$c43 = "html(";
    const peg$c44 = peg$literalExpectation("html(", false);
    const peg$c45 = function (v) {
    ...
    const peg$c46 = function (v) { return { renderType: "plain", value: v }; };
    const peg$c47 = "\"";
    const peg$c48 = peg$literalExpectation("\"", false);
    const peg$c49 = "\\\"";
    const peg$c50 = peg$literalExpectation("\\\"", false);
    const peg$c51 = peg$anyExpectation();
    const peg$c52 = function (s) { return s.replaceAll('\\"', '"'); };
    const peg$c53 = "'";
    const peg$c54 = peg$literalExpectation("'", false);
    const peg$c55 = "\\'";
    const peg$c56 = peg$literalExpectation("\\'", false);
    const peg$c57 = function (s) { return s.replaceAll('\\\'', '\''); };
    const peg$c58 = function (k, v) { return { [k.trim()]: v.trim() }; };
    const peg$c59 = "--";
    ...
    const peg$c67 = "_";
    const peg$c68 = peg$literalExpectation("_", false);
    const peg$c69 = /^[A-Z]/;
    const peg$c70 = peg$classExpectation([["A", "Z"]], false, false);
    const peg$c71 = /^[a-z]/;
    const peg$c72 = peg$classExpectation([["a", "z"]], false, false);
    const peg$c73 = /^[\-.]/;
    const peg$c74 = peg$classExpectation(["-", "."], false, false);
    const peg$c75 = /^[0-9]/;
    const peg$c76 = peg$classExpectation([["0", "9"]], false, false);
    const peg$c77 = function () { return null; };
    const peg$c78 = " ";
    ...
    const peg$c86 = "\v";
    const peg$c87 = peg$literalExpectation("\v", false);
    const peg$c88 = "\f";
